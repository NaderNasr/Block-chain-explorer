      ...
      <div className={styles.grid}>
        <div className={styles.item}>
          <p>
            ...
            {moment.unix(Number(timeStamp)).format('LLL')}
          </p>
        </div>
        <div className={styles.item}>
          <p>
            <strong>Value:</strong> {convertToEther(Number(value))}
          </p>
        </div>
        <div className={styles.item}>
          <p>
            <strong>Gas Price:</strong> {convertToGwei(Number(gasPrice))}
          </p>
        </div>
        <div className={styles.item}>
          <p>
            <strong>Confirmation status:</strong>{' '}
            {confirmations ? 'Success' : 'Failed'}
          </p>
        </div>
        <div className={styles.item}>
          <p>
